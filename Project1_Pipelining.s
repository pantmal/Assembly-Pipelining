...
Numbers:	.byte 37, 10, 8, 73, 72, 124, 5, 28, 49, 110, 106, 39, 38, 73, 78, 112
			...
			.byte 59, 76, 28, 46, 38, 118, 17, 9, 66, 81, 45, 69, 84, 77, 120, 50	
		 	...
		 	.byte 68, 8, 87, 15, 57, 76, 124, 79, 4, 13, 35, 12, 40, 79, 68, 120	
		 	...
		 	.byte 124, 126, 24, 12, 38, 100, 29, 116, 6, 106, 72, 26, 34, 117, 113, 32	
		 	...
		 	.byte 121, 103, 44, 55, 66, 32, 18, 105, 82, 70, 42, 40, 85, 66, 121, 11 	
		 	...
		 	.byte 43, 103, 50, 65, 92, 67, 91, 3, 37, 113, 33, 106, 26, 96, 71, 22 	
		 	...
		 	.byte 117, 33, 22, 37, 81, 27, 55, 61, 98, 15, 55, 2, 19, 73, 62, 75 	
		 	.byte 100, 112, 102, 113, 107, 97, 11, 28, 58, 55, 41, 25, 121, 9, 44, 86
		 	.byte 105, 95, 99, 124 		#Total Sum: 30617
...
loop:	lbu $s1, Numbers($t0)	#$t0 is index of 1st tenth
		...
		daddi $s2 ,$zero, sum   #print the "Sum = " string 
		daddi $v0, $zero, 4
		sd $s2, ($a2)        
        sd $v0, ($a1)
